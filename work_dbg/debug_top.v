...
module edb_top (
    ...
    input  [7:0] la0_probe20,
    input  [7:0] la0_probe21,
    input  la0_probe22,
    input  la1_clk,
    input  la1_probe0,
    input  [7:0] la1_probe1,
    input  la1_probe2,
    input  la2_clk,
    ...
    input  la3_probe0,
    input  la4_clk,
    input  [47:0] la4_probe0,
    input  la5_clk,
    input  la5_probe0,
    input  [7:0] la5_probe1,
    input  la5_probe2,
    input  la6_clk,
    input  la6_probe0
);
    ...
    wire la4_module_select;
    wire la4_module_inhibit;
    wire la4_module_tdo;

    wire la5_module_select;
    wire la5_module_inhibit;
    wire la5_module_tdo;

    wire la6_module_select;
    wire la6_module_inhibit;
    wire la6_module_tdo;
    ...
    assign la4_module_select        = edb_module_selects[4];
    assign edb_module_inhibit[4]    = la4_module_inhibit;
    assign edb_module_tdo[4]        = la4_module_tdo;
    assign la5_module_select        = edb_module_selects[5];
    assign edb_module_inhibit[5]    = la5_module_inhibit;
    assign edb_module_tdo[5]        = la5_module_tdo;
    assign la6_module_select        = edb_module_selects[6];
    assign edb_module_inhibit[6]    = la6_module_inhibit;
    assign edb_module_tdo[6]        = la6_module_tdo;
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'h4265caf9a4c2487d9ed6fb4d86c657a9 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 8 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 3 ),
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'ha1c8deeb76bd4d9593849cca751394d8 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 8 ),
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'hcb3f9136348e41a7bb9c7b3841fdec31 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 8 ),
        .PROBE0_TYPE        ( 1 )
    ) la2 (
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'h3980691a426c4be595376e01395d28f0 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 )
    ) la3 (
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'ha21ceb4623d64252984b5ffbb3d831d2 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 48 ),
        .PROBE0_TYPE        ( 1 )
    ) la4 (
        ...
        .bscan_UPDATE                   ( bscan_UPDATE ),
        .edb_user_dr            ( edb_user_dr ),
        .edb_module_select      ( la4_module_select  ),
        .edb_module_inhibit     ( la4_module_inhibit ),
        .edb_module_tdo         ( la4_module_tdo ),
        .clk                    ( la4_clk ),
        .trig_in                ( 1'b0 ),
        .trig_in_ack            (  ),
        .trig_out               (  ),
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'ha4105030ad8c4a05898534004e9491ad ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 8 ),
        ...
        .bscan_UPDATE                   ( bscan_UPDATE ),
        .edb_user_dr            ( edb_user_dr ),
        .edb_module_select      ( la5_module_select  ),
        .edb_module_inhibit     ( la5_module_inhibit ),
        .edb_module_tdo         ( la5_module_tdo ),
        .clk                    ( la5_clk ),
        .trig_in                ( 1'b0 ),
        .trig_in_ack            (  ),
        .trig_out               (  ),
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'h2304c138f8914feca303b39adeca584f ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 )
    ) la6 (
        ...
        .bscan_UPDATE                   ( bscan_UPDATE ),
        .edb_user_dr            ( edb_user_dr ),
        .edb_module_select      ( la6_module_select  ),
        .edb_module_inhibit     ( la6_module_inhibit ),
        .edb_module_tdo         ( la6_module_tdo ),
        .clk                    ( la6_clk ),
        .trig_in                ( 1'b0 ),
        .trig_in_ack            (  ),
        .trig_out               (  ),
